...
if os.path.exists(logo_header):
    ...
    <div style="display:flex; align-items:center; margin-bottom:20px;">
        ...
        <div>
            <h2 style="margin:0; color:#2C3E50; font-family:'{font_family}'; font-size:32px;">SOFIPS: Ingeniería Sísmica Avanzada</h2>
            <p style="margin:5px 0 0 0; color:gray; font-family:'{font_family}'; font-size:16px;">Desarrollo: Ing. Arnold Mendo Rodriguez</p>
        </div>
    </div>
