...
with col_der:
    ...
    if ejecutar:
        norma = NormaE030()
        # Obtenemos valores en 'g' desde el motor
        ...
        p4.metric("Periodo TP", f"{info['TP']} s")
        p5.metric("Periodo TL", f"{info['TL']} s")
        ...
        with st.expander("📋 Ver Tabla de Datos y Descargar"):
            ...
            # Descarga TXT (Dos columnas para ETABS)
